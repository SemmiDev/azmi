<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight text-gray-600">
            {{ __('Tambah Tembang Dolanan') }}
        </h2>
    </x-slot>

    <div class="container mx-auto mt-8 p-5 rounded-xl bg-gradient-to-r from-sky-200 to-pink-200 shadow-md">
        <form action="{{ route('tembang_dolanan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="mb-4">
                <label for="title" class="block text-sm font-medium text-gray-600">Judul</label>
                <input type="text" name="title" id="title" placeholder="Judul Tembang Dolanan"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" placeholder="Deskripsi Tembang Dolanan."
            ...
            <div class="mb-4">
                ...
                <textarea placeholder="Lirik tembang dolanan disini." name="lyric"
            ...
            <div class="mb-4">
                <label for="video" class="block text-sm font-medium text-gray-600">Video (YouTube Link)</label>
                <input type="text" name="video" id="video" placeholder="https://www.youtube.com/..."
