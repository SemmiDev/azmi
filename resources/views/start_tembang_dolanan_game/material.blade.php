<x-app-layout>
    <div class="container mx-auto mt-8 p-5 rounded-xl bg-gradient-to-r from-sky-200 to-pink-200 shadow-md">
        <h1 class="text-4xl text-center font-bold">{{ $tembangDolanan->title }}</h1>

        <p class="text-center text-lg italic my-5">{{ $tembangDolanan->description }}</p>

        <div class="flex justify-center mb-4">
            <div>
                <a href="{{ route('start_tembang_dolanan_game.play', ['tembangDolanan' => $tembangDolanan]) }}" class="px-4 py-2 flex gap-2 bg-blue-500 text-white rounded-md">
        ...
        <div class="flex flex-col items-center gap-3">
            ...
            <p class="text-starttext-xl mt-5">{{ $tembangDolanan->lyric }}</p>
        </div>
