        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-gradient-to-br from-blue-300 to-green-300 p-6 rounded-lg shadow-md">
                    <img src="/tembang-dolanan.png" alt="Image 1" class="mb-4 rounded-md w-72 h-60 object-cover">
                ...
                <div class="bg-gradient-to-br from-purple-300 to-red-300 p-6 rounded-lg shadow-md">
                    <img src="/arane-kewan.png" alt="Image 2" class="mb-4 rounded-md w-72 h-60 object-cover">
                ...
                <div class="bg-gradient-to-br from-green-300 to-blue-300 p-6 rounded-lg shadow-md">
                    <img src="/unguh-unguh-basa.png" alt="Image 3" class="mb-4 rounded-md w-72 h-60 object-cover">
                ...
                <div class="bg-gradient-to-br from-red-300 to-purple-300 p-6 rounded-lg shadow-md">
                    <img src="/dongeng.png" alt="Image 4" class="mb-4 rounded-md w-72 h-60 object-cover">
      ...
      <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
        <div class="mx-auto max-w-sm lg:max-w-none">
          <p class="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
            Si-Sawa adalah aplikasi pembelajaran bahasa Jawa yang menyenangkan. Aplikasi ini dibuat untuk membantu anak-anak dalam mempelajari bahasa Jawa dengan cara yang menyenangkan.
          </p>
