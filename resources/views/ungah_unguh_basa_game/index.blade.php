<x-app-layout>
    ...
    <div class="container mx-auto mt-8 p-5 rounded-xl bg-gradient-to-r from-sky-200 to-pink-200 shadow-md">
        ...
        <div class="flex justify-end mb-4 gap-2">
            ...
            <a href="{{ route('ungah_unguh_basa_game.create', ['ungahUnguhBasa' => $ungahUnguhBasa]) }}"
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 text-start border-b">
                            <div class="space-x-2 flex justify-center">
                                <form action="/ungah_unguh_basa_game/{{ $game->id }}/destroy" method="POST"
